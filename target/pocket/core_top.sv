...
module core_top (
  ...
  synch_3 #(
      ...
      {reset_button, cpu_turbo_enabled, gsu_turbo_enabled,
       multitap_enabled, use_square_pixels, blend_enabled},
      {reset_button_s, cpu_turbo_enabled_s, gsu_turbo_enabled_s,
       multitap_enabled_s, use_square_pixels_s, blend_enabled_s},
      clk_sys_21_48
  );
